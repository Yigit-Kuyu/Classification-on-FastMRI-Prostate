...
def get_parser():
    ...
    parser.add_argument('--config_file', type=str, default='configs/t2_final.yaml')           # config file which has all the training inputs
    parser.add_argument('--index_seed', type=int, default=0)            # Seed number for reproducibility for all numpy, random, torch
    return parser
